...
export function UploadCTA() {
  ...
  return (
    ...
    >
      {/* Soft color blobs */}
      <div className="absolute -left-16 top-8 h-72 w-72 rounded-full bg-[color:var(--brand-purple)] opacity-50 blur-3xl" />
      <div className="absolute right-0 top-1/4 h-64 w-64 rounded-full bg-[color:var(--brand-blue)] opacity-45 blur-3xl" />
      <div className="absolute left-1/3 bottom-0 h-72 w-72 rounded-full bg-[color:var(--brand-coral)] opacity-45 blur-3xl" />
      <div className="absolute -right-10 -bottom-10 h-64 w-64 rounded-full bg-[color:var(--brand-yellow)] opacity-40 blur-3xl" />
